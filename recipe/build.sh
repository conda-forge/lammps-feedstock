...
if [[ -z "$MACOSX_DEPLOYMENT_TARGET" ]]; then
  ...
  if [[ ${cuda_compiler_version} != "None" ]]; then
    ...
    export CMAKE_ARGS="$CMAKE_ARGS -D CMAKE_INCLUDE_PATH=$PREFIX/include:$PREFIX/x86_64-conda-linux-gnu/sysroot/usr/include:$PREFIX/targets/x86_64-linux/include"
